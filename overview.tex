...
%Supporting these objectives is simple, i.e., replacing Eq.1 with user-specified objectives. 
...
%\para{Measurement point selection}. 
%This decision achieves 100\% coverage while reducing the number of activated switches by 33\% compared to full INT deployment. 

%Thus, it balancing the tradeoff between coverage efficiency and proximity constraints through penalty weight optimization.

%\para{Measurement data collection}. 
