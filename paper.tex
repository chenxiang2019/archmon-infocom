...
\newcommand{\sysname}{RINC\xspace}
\newcommand{\gurobi}{RINC-OPT\xspace}
...
\title{\makebox[\linewidth]{\parbox{\dimexpr\textwidth+1cm\relax}{\centering \sysname: Resource-Efficient In-Network Computing}}\vspace{-0.1in}}
% \author{
