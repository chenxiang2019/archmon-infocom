...
\title{\makebox[\linewidth]{\parbox{\dimexpr\textwidth+1cm\relax}{\centering \sysname: Optimizing Sketch-INT Co-Design for Accurate and Resource-Efficient Measurement}}\vspace{-0.1in}}
% \author{
